                ...
                <div className="border rounded-lg shadow-sm bg-[#fdf9f7] p-4 max-w-md">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-[#4B4E4B] text-sm">
                        of trending brands
                      </p>
                    </div>
      ...
      {activeNav !== "Offers" && (
        <div className="flex flex-col items-center justify-center h-[80vh] p-3 ">
          <h1 className="text-sm  text-[#4B4E4B] m-4 text-center">
            There is no content here yet for {activeNav} page
          </h1>
          <button
            onClick={() => setActiveNav("Offers")}
            className="bg-[#C16B3E] text-white p-4 rounded-md mb-4"
          >
